    ...
    try:
        with open(file, "r") as f:
            for l in f:
                ...
                if re.search('bw', l) and re.search('avg', l):
                ...
                elif re.search(' lat', l) and re.search('avg', l):
                    l = l.split('=')
                    bw=l[4].split(',')[0]
                    print(str(bw), end=" ")
                    ...
                    c = l[3]
                    d = l[4]
                    print(a.split('[')[1].split(']')[0].lstrip(' '), end=" ")
                    print(b.split('[')[1].split(']')[0].lstrip(' '), end=" ")
                    print(c.split('[')[1].split(']')[0].lstrip(' '), end=" ")
                    print(d.split('[')[1].split(']')[0].lstrip(' '), end=" ")

                elif re.search("99\.99th", l):
                    l = l.split('=')
